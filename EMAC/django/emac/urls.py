...
urlpatterns = [
    ...
    re_path(r'^CGP/.*$(?i)', RedirectView.as_view(url=TOOLS_SITE_URL + "/CGP")),
    re_path(r'^exovista/.*$(?i)', RedirectView.as_view(url=TOOLS_SITE_URL + "/exovista")),
    re_path(r'^EBC/.*$(?i)', RedirectView.as_view(url=TOOLS_SITE_URL + "/EBC")),
    re_path(r'^ECI/.*$(?i)', RedirectView.as_view(url=TOOLS_SITE_URL + "/ECI")),
    re_path(r'^PyATMOS/.*$(?i)', RedirectView.as_view(url=TOOLS_SITE_URL + "/PyATMOS")),
    re_path(r'^REPAST/.*$(?i)', RedirectView.as_view(url=TOOLS_SITE_URL + "/REPAST")),
