# Generated by Django 3.2.8 on 2024-11-21 22:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscriber_email', models.EmailField(error_messages={'unique': 'A subscription already exists for this email address. Please update your existing subscription instead.'}, help_text='Please provide an email address at which EMAC can alert you.', max_length=254, unique=True, verbose_name='your email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_app_on_emac', models.BooleanField(default=False, help_text='Would you like your tool to be hosted/executed on an EMAC server?', verbose_name='host web-app?')),
                ('host_data_on_emac', models.BooleanField(default=False, help_text='Would you like to store data/model output on a web-accessible EMAC server?', verbose_name='host output?')),
                ...
                ('submitter_email', models.EmailField(help_text='Please provide an email address at which the EMAC team can contact you', max_length=254, verbose_name='your email')),
                ...
                ('categories', models.ManyToManyField(blank=True, help_text='The categories that are applicable to the resource', related_name='_website_submission_categories_+', to='website.Category')),
                ('collections', models.ManyToManyField(blank=True, help_text='The collections that are applicable to the resource', related_name='_website_submission_collections_+', to='website.Collection')),
                ...
                ('tool_types', models.ManyToManyField(blank=True, help_text='The tool types that are applicable to the resource', related_name='_website_submission_tool_types_+', to='website.ToolType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ascl_id', models.CharField(blank=True, default='', help_text='ASCL ID (YYMM.NNN)', max_length=8, verbose_name='ASCL ID')),
                ('ascii_credits', models.CharField(blank=True, max_length=256)),
                ('is_hosted', models.BooleanField(default=False, help_text='Indicates whether the resource is hosted (executed) on EMAC servers')),
                ('is_published', models.BooleanField(default=False, help_text='Indicates whether this is a published EMAC resource')),
                ('subdomain', models.CharField(blank=True, help_text='The EMAC subdomain of a hosted resource', max_length=20)),
                ...
                ('categories', models.ManyToManyField(blank=True, help_text='The categories that are applicable to the resource', related_name='_website_resource_categories_+', to='website.Category')),
                ('collections', models.ManyToManyField(blank=True, help_text='The collections that are applicable to the resource', related_name='_website_resource_collections_+', to='website.Collection')),
                ('related_resources', models.ManyToManyField(blank=True, related_name='_website_resource_related_resources_+', to='website.Resource')),
                ('submission', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resource', to='website.submission')),
                ('tool_types', models.ManyToManyField(blank=True, help_text='The tool types that are applicable to the resource', related_name='_website_resource_tool_types_+', to='website.ToolType')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_notes', models.TextField(blank=True)),
                ('SEEC_tool', models.BooleanField(default=False, help_text='Check if the tool is related to SEEC', verbose_name='SEEC Related Tool')),
                ('categories', models.ManyToManyField(blank=True, help_text='The categories that are applicable to the resource', related_name='_website_inlitresource_categories_+', to='website.Category')),
                ('collections', models.ManyToManyField(blank=True, help_text='The collections that are applicable to the resource', related_name='_website_inlitresource_collections_+', to='website.Collection')),
                ...
                ('tool_types', models.ManyToManyField(blank=True, help_text='The tool types that are applicable to the resource', related_name='_website_inlitresource_tool_types_+', to='website.ToolType')),
            ],
            options={
                'ordering': ['name'],
            },
