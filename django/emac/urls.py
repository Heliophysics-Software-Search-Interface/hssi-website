...
urlpatterns = [
    ...
    re_path(r'(?i)^CGP/.*$', RedirectView.as_view(url=TOOLS_SITE_URL + "/CGP")),
    re_path(r'(?i)^exovista/.*$', RedirectView.as_view(url=TOOLS_SITE_URL + "/exovista")),
    re_path(r'(?i)^EBC/.*$', RedirectView.as_view(url=TOOLS_SITE_URL + "/EBC")),
    re_path(r'(?i)^ECI/.*$', RedirectView.as_view(url=TOOLS_SITE_URL + "/ECI")),
    re_path(r'(?i)^PyATMOS/.*$', RedirectView.as_view(url=TOOLS_SITE_URL + "/PyATMOS")),
    re_path(r'(?i)^REPAST/.*$', RedirectView.as_view(url=TOOLS_SITE_URL + "/REPAST")),
    re_path(r'(?i)^tpfplotter/.*$', RedirectView.as_view(url=TOOLS_SITE_URL + "/tpfplotter")),
