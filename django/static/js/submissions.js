...
$(document).ready(function() {
	...
	$("input[name='categories']").change(function() {
	 ...
	 $('<div class="expand-additional"><a class="expand-additional"><div class="expand-arrow"></div><div class="expand-text"><div>Select Resource\'s Categories</div><div>(click to expand)</div></div></a></div>').insertBefore(scienceCategories);
