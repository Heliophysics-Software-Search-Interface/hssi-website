...
TTEXPL_PERSISTENTIDENTIFIER = "The computer programming languages most important for the software."
TTEXPL_PROGRAMMINGLANGUAGE = "Date of first broadcast/publication. "
TTEXPL_PUBLICATIONDATE = "The author of this software."
TTEXPL_AUTHORS = "The affiliation of the author, such as an institution or other entity."
TTEXPL_AUTHORAFFILIATION = "The identifier of the affiliation entity, such as the ROR, if one exists."
TTEXPL_AUTHORAFFILIATIONIDENTIFIER = "The identifier of the author, such as the ORCiD."
TTEXPL_AUTHORIDENTIFIER = "The publisher (entity) of the creative work."
TTEXPL_PUBLISHER = "The identifier of the publisher, such as the ROR. Note that Zenodo does not have an ROR, so the URL should be included instead."
TTEXPL_PUBLISHERIDENTIFIER = "The instrument the software is designed to support."
TTEXPL_RELATEDINSTRUMENTS = "The globally unique persisent identifier associated with the instrument, such as a DOI."
TTEXPL_RELATEDINSTRUMENTIDENTIFIER = "The mission, observatory, and/or group of instruments the software is designed to support."
TTEXPL_RELATEDOBSERVATORIES = "The name of the software"
TTEXPL_SOFTWARENAME = "Version of the software instance."
TTEXPL_VERSIONNUMBER = "Publication date of the indicated version of the software."
TTEXPL_VERSIONDATE = "Description of the change(s) between the last major release and this release. This description will be shown below the software description on the landing page."
TTEXPL_VERSIONDESCRIPTION = "The globally unique persistent identifier for the specific version of the software (e.g. the DOI for the version)."
TTEXPL_VERSIONPID = "The globally unique persistent identifier for the software (e.g. the concept DOI for all versions)."
...
TTBEST_PERSISTENTIDENTIFIER = "Select the most important languages of the software (e.g. Python, Fortran, C), then enter any other needed details, e.g. the flavor of Fortran. This is not meant to be an exhaustive list."
TTBEST_PROGRAMMINGLANGUAGE = "Used for the initial version of the software. The publication date should be in ISO 8601 format, basically the year, month, and day of the month separated by dashes: YYYY-MM-DD."
TTBEST_PUBLICATIONDATE = "Minimum should be Last name, first initial. Multiple authors should be included in separate author fields or separated by semicolons (e.g. Smith, J; Ferrari, A.M.)."
TTBEST_AUTHORS = "Please enter the complete name of the affiliated entity without using acronyms (e.g. Center for Astrophysics Harvard & Smithsonian). If you have more than one affiliation, please enter them separately."
TTBEST_AUTHORAFFILIATION = "Please enter the complete identifier for each affiliation separately if one exists, e.g. https://ror.org/03c3r2d17. "
TTBEST_AUTHORAFFILIATIONIDENTIFIER = "Please enter the complete identifier, e.g. https://orcid.org/0000-0003-0875-2023."
TTBEST_AUTHORIDENTIFIER = "For software where a DOI has been obtained through Zenodo, such as through the GitHub-Zenodo workflow, Zenodo is the correct entry. If no DOI has been obtained, indicate the code repository here, such as GitHub or GitLab."
TTBEST_PUBLISHER = "Please enter the complete identifier, e.g. https://ror.org/03c3r2d17 when the publisher has a ROR or the URL (e.g. https://zenodo.org) otherwise."
TTBEST_PUBLISHERIDENTIFIER = "Begin typing the item's name in the box. Instruments listed in the IVOA will appear in a dropdown list, please choose the correct one. If your instrument is not listed, please type in the full name."
TTBEST_RELATEDINSTRUMENTS = "If the instrument has a DOI, please enter the full DOI here, e.g. https://doi.org/10.5281/zenodo.13287868. Entering the DOI enables us to improve the linking of your software to the referenced instrument."
TTBEST_RELATEDINSTRUMENTIDENTIFIER = "Begin typing the item's name in the box. Missions and Observatories listed in the IVOA will appear in a dropdown list, please choose the correct one. If your mission or observatory is not listed, please type in the full name."
TTBEST_RELATEDOBSERVATORIES = "The name of the software package as listed on the code repository."
TTBEST_SOFTWARENAME = "The version number of the software is often an alphanumeric value, which should be easily accessible on the code repository page, e.g. v1.0.0."
TTBEST_VERSIONNUMBER = "The version publication date should be in ISO 8601 format, basically the year, month, and day of the month separated by dashes: YYYY-MM-DD."
TTBEST_VERSIONDATE = "The version description should be a brief summary of the major changes in the new version, such as deprecated and new functionalities, new features, resolved bugs, and so on."
TTBEST_VERSIONDESCRIPTION = "If the software version already has a DOI, please enter the full DOI here, e.g. https://doi.org/10.5281/zenodo.13287868. Entering the DOI also enables us to automatically populate metadata in our system from that DOI. "
TTBEST_VERSIONPID = "If the software already has a DOI, please enter the full DOI here, e.g. https://doi.org/10.5281/zenodo.13287868. Entering the DOI also enables us to automatically populate metadata in our system from that DOI. "
...
TTBEST_SUBMITTERNAME = "Last/surname, given name and initials (e.g. Doe, Jack L.)."
