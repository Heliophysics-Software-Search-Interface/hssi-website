...
TTEXPL_INPUTFORMATS = "The file formats the software supports for data input or output."
TTEXPL_OUPUTFORMATS = "The file formats the software supports for data input or output."
...
TTBEST_INPUTFORMATS = "Please select all the file formats that your software supports for either input files or files the software generates. Only file formats supported by the software should be indicated."
TTBEST_OUPUTFORMATS = "Please select all the file formats that your software supports for either input files or files the software generates. Only file formats supported by the software should be indicated."
