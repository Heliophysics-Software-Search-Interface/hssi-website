...
TTBEST_PROGRAMMINGLANGUAGE = "Select the most important languages of the software (e.g. Python, Fortran, C), then enter any other needed details, e.g. the flavor of Fortran. This is not meant to be an exhaustive list."
TTBEST_PUBLICATIONDATE = "Used for the initial version of the software. The publication date should be in ISO 8601 format, basically the year, month, and day of the month separated by dashes: YYYY-MM-DD."
TTBEST_AUTHORS = "Minimum should be Last name, first initial. Multiple authors should be included in separate author fields or separated by semicolons (e.g. Smith, J; Ferrari, A.M.)."
...
TTBEST_PUBLISHER = "For software where a DOI has been obtained through Zenodo, such as through the GitHub-Zenodo workflow, Zenodo is the correct entry. If no DOI has been obtained, indicate the code repository here, such as GitHub or GitLab."
...
TTBEST_VERSIONDATE = "The version publication date should be in ISO 8601 format, basically the year, month, and day of the month separated by dashes: YYYY-MM-DD."
