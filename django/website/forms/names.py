...
TTBEST_AUTHORAFFILIATION = "Please enter the complete name of the affiliated entity without using acronyms (e.g. Center for Astrophysics Harvard & Smithsonian). If you have more than one affiliation, use the \"+ add\" button to enter one per field."
...
TTBEST_RELATEDPUBLICATIONS = "Please enter the URLs (ideally DOIs) for all notable publications the software is cited in. Use the \"+ add\" button to enter one URL per field."
TTBEST_RELATEDDATASETS = "Please enter the URLs (ideally DOIs) for all datasets related to the software. Use the \"+ add\" button to enter one URL per field."
...
TTBEST_FUNDER = "The name of the organization that provided the funding, e.g. National Aeronautics and Space Administration. Please avoid acronyms and enter one organization per field."
...
TTBEST_SUBMITTERNAME = "Given name, middle initial(s), and last/surname (e.g. Jack L. Doe)."
...
MODEL_FIELD_MAP = {
	...
	FIELD_RELATEDOBSERVATORIES: "related_observatories",
	FIELD_RELATEDOBSERVATORYIDENTIFIER: "identifier",
	FIELD_SOFTWARENAME: "software_name",
