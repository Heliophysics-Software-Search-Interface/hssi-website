...
class TestForm(forms.Form):
    ...
    def set_tooltips(self):
        ...
        self.fields['field_authors'].tt_explanation = "The author of this content or rating."
        ...
        self.fields['field_metadata_license'].tt_explanation = "The full name of the license assigned to the metadata (e.g. Creative Commons Zero v1.0 Universal). Licenses supported by SPDX are preferred. See https://spdx.org/licenses/ for details."
        ...
        self.fields['field_metadata_license'].tt_best_practice = "Will always be 'Creative Commons Zero v1.0 Universal' for HSSI metadata."
