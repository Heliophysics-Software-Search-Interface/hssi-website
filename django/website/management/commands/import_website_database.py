...
from website.models import Category, Collection, Feedback, NewsItem, Resource, Submission, TeamMember,ToolType, InLitResource

class Command(BaseCommand):

    help = "Imports the website database from the exported config files"
    ...
    def handle(self, *args, **kwargs):
        ...
        print("Disabling auto-export of website database changes ...")
        ...
        print("Re-importing all Abstract Tags to re-establish any parent-child relationships ...")
        self.import_db_file(CATEGORIES_FILE_PATH, Category)
        self.import_db_file(COLLECTIONS_FILE_PATH, Collection)
        self.import_db_file(TOOL_TYPES_FILE_PATH, ToolType)
        ...
        print("Enabling auto-export of website database changes ...")
