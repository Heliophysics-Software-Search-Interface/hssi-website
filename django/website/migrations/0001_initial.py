    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_code_or_data_link', models.URLField(blank=True, help_text='<strong> Add one link only - </strong>If your resource is not publicly available and you would like HSSI to host it, please provide a (private) link to your source code', verbose_name='private code/data link')),
                ('host_app_on_hssi', models.BooleanField(default=False, help_text='Would you like your tool to be hosted/executed on an HSSI server?', verbose_name='host web-app?')),
                ('host_data_on_hssi', models.BooleanField(default=False, help_text='Would you like to store data/model output on a web-accessible HSSI server?', verbose_name='host output?')),
