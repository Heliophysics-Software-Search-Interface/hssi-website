# Generated by Django 5.1.5 on 2025-03-25 22:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='software',
            name='dataInputs',
            field=models.ManyToManyField(related_name='softwares_data', to='website.functionality'),
        ),
        migrations.AddField(
            model_name='software',
            name='funder',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='softwares_funder', to='website.organization'),
        ),
        migrations.AddField(
            model_name='software',
            name='keywords',
            field=models.ManyToManyField(related_name='softwares', to='website.keyword'),
        ),
        migrations.AddField(
            model_name='software',
            name='license',
        ...
        migrations.AddField(
            model_name='software',
            name='operatingSystem',
            field=models.ManyToManyField(related_name='softwares', to='website.operatingsystem'),
        ),
        migrations.AddField(
            model_name='software',
            name='programmingLanguage',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='softwares', to='website.ivoaentry'),
        ),
        migrations.AddField(
            model_name='software',
            name='relatedObservatories',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='observatories', to='website.ivoaentry'),
        ),
        migrations.AddField(
            model_name='software',
            name='relatedPhenomena',
            field=models.ManyToManyField(related_name='softwares', to='website.phenomenatype'),
        ),
        migrations.AddField(
            model_name='software',
            name='softwareFunctionality',
            field=models.ManyToManyField(related_name='softwares', to='website.functionality'),
        ),
        migrations.AddField(
            model_name='software',
            name='supportedFileFormats',
            field=models.ManyToManyField(related_name='softwares', to='website.fileformat'),
        ),
        migrations.CreateModel(
            name='Submission',
            fields=[
        ...
        migrations.AddField(
            model_name='software',
            name='submissionInfo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='software', to='website.submissioninfo'),
        ),
        migrations.CreateModel(
            name='ToolType',
            fields=[
