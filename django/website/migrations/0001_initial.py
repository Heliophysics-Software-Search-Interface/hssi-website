    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.URLField(blank=True, null=True)),
                ('license', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='datasets', to='website.license')),
                ('creator', models.ManyToManyField(blank=True, related_name='datasets', to='website.person')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='softwares', to='website.dataset'),
        ),
        migrations.AddField(
            model_name='software',
