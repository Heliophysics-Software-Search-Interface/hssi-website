...
from ..forms import (
    ...
    SUBMISSION_FORM_OBSERVATORY, SUBMISSION_FORM_AUTHOR, SUBMISSION_FORM_CONTRIBUTOR,
    SUBMISSION_FORM_AWARD, SUBMISSION_FORM_DATASET, SUBMISSION_FORM_INSTRUMENT,
    SUBMISSION_FORM_LICENSE, SUBMISSION_FORM_AUTHOR_AFFILIATION, 
    SUBMISSION_FORM_CONTRIBUTOR_AFFILIATION, SUBMISSION_FORM_PUBLISHER, 
