...
_FIELD_ALIAS_MAP: dict[str, list[str] | None] = {
    ...
    "software_name":            ["software_name__icontains"],
    "description":              ["description__icontains", "concise_description__icontains"],
    "repo":                     ["code_repository_url__icontains"],
    "repository":               ["code_repository_url__icontains"],
    "code_repository_url":      ["code_repository_url__icontains"],
    "docs":                     ["documentation__icontains"],
    "documentation":            ["documentation__icontains"],
    "pid":                      ["persistent_identifier__icontains"],
    "identifier":               ["persistent_identifier__icontains"],
    "persistent_identifier":    ["persistent_identifier__icontains"],
    ...
    "keywords":                 ["keywords__name__icontains"],
    "lang":                     ["programming_language__name__icontains"],
    "language":                 ["programming_language__name__icontains"],
    "programming_language":     ["programming_language__name__icontains"],
    "license":                  ["license__name__icontains"],
    "licence":                  ["license__name__icontains"],
    "region":                   ["related_region__name__icontains"],
    "related_region":           ["related_region__name__icontains"],
    "phenomenon":               ["related_phenomena__name__icontains"],
    "phenomena":                ["related_phenomena__name__icontains"],
    "related_phenomena":        ["related_phenomena__name__icontains"],
    "instrument":               ["related_instruments__name__icontains", "related_instruments__abbreviation__icontains"],
    "related_instruments":      ["related_instruments__name__icontains", "related_instruments__abbreviation__icontains"],
    "observatory":              ["related_observatories__name__icontains", "related_observatories__abbreviation__icontains"],
    "related_observatories":    ["related_observatories__name__icontains", "related_observatories__abbreviation__icontains"],
    "funder":                   ["funder__name__icontains"],
    "award":                    ["award__name__icontains"],
    "status":                   ["development_status__name__icontains"],
    "dev_status":               ["development_status__name__icontains"],
    "development_status":       ["development_status__name__icontains"],
    "os":                       ["operating_system__name__icontains"],
    "operating_system":         ["operating_system__name__icontains"],
    "cpu":                      ["cpu_architecture__name__icontains"],
    "cpu_architecture":         ["cpu_architecture__name__icontains"],
    "source":                   ["data_sources__name__icontains"],
    "data_source":              ["data_sources__name__icontains"],
    "data_sources":             ["data_sources__name__icontains"],
    "function":                 ["software_functionality__name__icontains"],
    "functionality":            ["software_functionality__name__icontains"],
    "category":                 ["software_functionality__name__icontains"],
    "software_functionality":   ["software_functionality__name__icontains"],
    "input":                    ["input_formats__name__icontains", "input_formats__extension__icontains"],
    "input_format":             ["input_formats__name__icontains", "input_formats__extension__icontains"],
    "input_formats":            ["input_formats__name__icontains", "input_formats__extension__icontains"],
    "output":                   ["output_formats__name__icontains", "output_formats__extension__icontains"],
    "output_format":            ["output_formats__name__icontains", "output_formats__extension__icontains"],
    "output_formats":           ["output_formats__name__icontains", "output_formats__extension__icontains"],
    "publication":              ["related_publications__name__icontains", "reference_publication__name__icontains"],
    "related_publications":     ["related_publications__name__icontains"],
    "reference_publication":    ["reference_publication__name__icontains"],
    "dataset":                  ["related_datasets__name__icontains"],
    "related_datasets":         ["related_datasets__name__icontains"],
    "related_software":         ["related_software__name__icontains"],
    "interoperable":            ["interoperable_software__name__icontains"],
    "interoperable_software":   ["interoperable_software__name__icontains"],
